...
$packageArgs = @{
    ...
    fileType        = 'exe'
    url64           = 'https://get.enterprisedb.com/postgresql/postgresql-16.13-1-windows-x64.exe'
    checksum64      = '8868A08CBBFE161F2A09343CF04EE8F8217638148B9A51F886503CFC8DE338BF'
